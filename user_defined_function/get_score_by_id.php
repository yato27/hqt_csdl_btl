...
<body>
    <h1>function lấy điểm môn hqt csdl cao nhất theo mã sinh viên</h1>
    ...
    <form action="get_score_by_id.php" method='get'>
        
        nhập câu lệnh function select get_score(ma_sinh_vien) vào bảng sinh_vien
